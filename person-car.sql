...
insert into person (first_name, last_name, gender, email, date_of_birth, country_of_birth) values ('John', 'SEcond', 'Male', 'johnSecond@feedburner.com', '1965-02-28', 'England');
